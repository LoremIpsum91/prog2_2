...
# print('own multiply: ', *multiply_matrix(matrix1, matrix2), sep='\n')
# print('\n')
# print('numpy multiply: ', '\n', checking_with_numpy(matrix1, matrix2))
# print('\n')
# print('transpose matrix: ', *trans(matrix1), sep='\n')
# print('\n')
# print('determinant of matrix: ', determinant(matrix2))
# print('\n')
# print('numpy det: ', np.linalg.det(matrix2))
# print('\n')
# print('matrix in power 2: ', *pow_matrix(matrix1), sep='\n')
# print('\n')
